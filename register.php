...
<section class="h-100 gradient-form" style="background-color: #eee;margin-top:2%;">
...
?>
    ...
    <form action="" method="POST" class="login-email">
      ...
      <p class="login-register-text">Have an account? <a href="index.php">Login Here</a>.</p>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2" style="background:url(https://media.giphy.com/media/eYwDrm9suCZzy/giphy.gif);">
